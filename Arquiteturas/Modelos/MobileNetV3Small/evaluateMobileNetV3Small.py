...
net.to(device)
net.eval()
print("MobileNetV3-Small model loaded for testing!")
...
plt.title(f"Confusion Matrix – MobileNetV3-Small – Accuracy: {accuracy:.2f}%")
plt.tight_layout()
plt.savefig("matriz_mobilenetv3small.png", dpi=300)
plt.show()